...
let HRToastPositionDefault  =   "bottom"//bottom
    ...
    */
    ...
    class func hr_toastThemeColor() -> UIColor {
        ...
        if color == nil {
            ...
            color = Config().AppOrangeColor.withAlphaComponent(0.1)
    ...
    func makeToast(message msg: String) {
        makeToast(message: msg, duration: HRToastDefaultDuration, position: bottomAnchor as AnyObject)//bottomAnchor
    }
    ...
    fileprivate func makeToastActivity(position pos: AnyObject, message msg: String = "") {
        ...
        if (!msg.isEmpty){
            ...
            //activityMessageLabel.font = (msg."") ? UIFont(name:UIView.hr_toastFontName(), size: 16) : UIFont(name:UIView.hr_toastFontName(), size: 13)
